...
CPPFLAGS=-Iinclude/ -Isrc/teg/ -I../lsx/include -I../libtttp -DMACOSX
...
CXXFLAGS=$(CFLAGS) -std=gnu++11 -Woverloaded-virtual -Wno-pmf-conversions -Wno-multichar
...
# Libraries.
LIBS=-framework SDL2 -L/usr/local/lib -lpng -lz -framework OpenGL -lgmp
